      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card className="p-8 mt-4">
          ...
          <section className="space-y-4 text-sm leading-relaxed">
            <p>
              Safar English Ka Coaching ("we", "us", "our") operates the Safar English Ka mobile and web
            ...
            <p>
              Email: <a href="mailto:shomarnashaurya@gmail.com" className="text-primary hover:underline">shomarnashaurya@gmail.com</a>
            </p>
          </section>
        </Card>
      </div>
