      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border safe-area-top">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
             {/* TODO(perf): convert logo PNG → WebP to shrink ~80% */}
             <img src={logo} alt="Safar English Ka" width={40} height={40} loading="eager" decoding="async" className="h-10 w-10 rounded-xl" />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Recommended Books - Safar English Ka',
