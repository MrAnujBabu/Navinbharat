...
app.use((req, res, next) => {
  if (__isProd) {
    ...
    // Dev: allow the Lovable preview iframe + local tools to embed the app.
    // X-Frame-Options is legacy and cannot express an allow-list; CSP
    // frame-ancestors is the source of truth in modern browsers.
    res.setHeader(
