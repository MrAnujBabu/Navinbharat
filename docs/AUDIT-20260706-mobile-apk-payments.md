...
- **10 CI workflows** cover the whole matrix (APK, Lighthouse, Playwright, Maestro on APK + smoke, Supabase keepalive, PDF-proxy keepalive, enrollment-bypass regression, dependency audit).
