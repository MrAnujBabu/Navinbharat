...
- [2026-08-15 deep-link hosts (audit + observer)](./2026-08-15-deep-link-hosts.md) — legacy host serves old package id, naveenbharat.vercel.app still placeholder; multi-package generator + live probe shipped; env var still unset by user.
- [2026-08-21 reader rotation session](./2026-08-21-reader-rotation-session.md) — chrome now rotates with the page; Notes sheet + toasts still portal outside the frame; landscape never device-verified (external_unmanaged auth).
- [2026-08-23 notes sheet + stepper pill audit](./2026-08-23-notes-stepper-audit.md) — 4/5; both pill carets measured unclipped at 390x844 and 844x390, Obsidian export hardened (frontmatter merge, folders, Android package visibility), Sentry 0 unresolved.
