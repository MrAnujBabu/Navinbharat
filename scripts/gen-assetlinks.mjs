...
if (!raw) {
  ...
  // Non-publish build (local / Vercel preview+dev / CI APK / e2e): informational
  // only — nothing is broken, the committed file is left untouched.
  console.log(
    "ℹ️  assetlinks: ANDROID_CERT_SHA256 not set — keeping committed file (non-publish build). See docs/DEEP-LINKS.md.",
  );
  process.exit(0);
}
