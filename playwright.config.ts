...
export default defineConfig({
  ...
  projects: [
    ...
    {
      // Landscape Android phone — the reader layout regression surface
      // (top white stripe, page not filling the width).
      name: "android-landscape",
      use: { ...devices["Pixel 5 landscape"] },
    },
    {
      // Landscape tablet — wider container, same fill rules.
