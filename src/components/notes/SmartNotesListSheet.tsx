                    ...
                    >
                      {isEditing ? (
                        <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                          ...
                          />
                          <Button aria-label="Save note name" size="icon" variant="ghost" className="h-8 w-8 shrink-0" onClick={(e) => { e.stopPropagation(); void commitRename(n); }}>
                            <Check className="h-4 w-4" />
                          </Button>
                          <Button aria-label="Cancel rename" size="icon" variant="ghost" className="h-8 w-8 shrink-0" onClick={(e) => { e.stopPropagation(); setEditingId(null); }}>
                            <X className="h-4 w-4" />
                          </Button>
                        </div>
                      ) : (
