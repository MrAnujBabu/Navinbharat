 ...
 */
const WhatsAppFloat = ({
  message = "Namaste! Mujhe Naveen Bharat ke courses ke baare mein jaankari chahiye.",
  liftOnMobile = true,
  hideOnMobile = false,
}: WhatsAppFloatProps) => {
  ...
  return (
    <a
      ...
      onClick={(e) => {
        // Native WebView ignores target="_blank" — hand off to WhatsApp instead.
        if (isNativeSync()) {
          e.preventDefault();
          void openSocialLink(href);
        }
      }}
