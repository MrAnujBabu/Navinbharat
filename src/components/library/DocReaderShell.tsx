...
import { hideStatusBar, showStatusBar, setStatusBarOverlay } from "../../lib/nativeChrome";
    ...
    <div ref={shellRef} className="fixed inset-0 z-[60] flex bg-background motion-safe:animate-in motion-safe:fade-in-0 motion-safe:duration-150" data-testid="doc-reader-shell">
      ...
      {itemId && isMobile && (
        <Sheet open={notesOpen} onOpenChange={setNotesOpen}>
          <SheetContent side="bottom" container={portalHost} className="h-[70%] rounded-t-2xl p-0">
