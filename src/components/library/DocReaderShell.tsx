...
export default function DocReaderShell({
  ...
  // Admin-gated: on-screen zoom controls are hidden unless enabled.
  const { enabled: zoomControlsEnabled } = usePdfZoomControls();
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* One-handed zoom control — admin-gated, OFF by default.
            Pinch and double-tap always work regardless of this flag. */}
        {zoomControlsEnabled && (
          <ReaderZoomControls
            zoom={zoom}
