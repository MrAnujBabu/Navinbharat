...
const Sidebar = ({ isOpen, onClose }: SidebarProps) => {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed top-0 left-0 h-full w-72 bg-sidebar z-[90] shadow-xl transition-transform duration-300 flex flex-col",
          isOpen ? "translate-x-0 pointer-events-auto" : "-translate-x-full pointer-events-none"
        )}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-sidebar-border safe-area-top">
