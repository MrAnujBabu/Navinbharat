...
const Header = ({ onMenuClick, userName }: HeaderProps) => {
  ...
  return (
    <>
    <header
      className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between px-2 pl-safe-l pr-safe-r md:px-4 py-1.5 bg-card border-b border-border safe-area-top min-h-[52px] md:min-h-[60px] shadow-sm"
    >
    ...
    <div aria-hidden="true" className="shrink-0 safe-area-top min-h-[52px] md:min-h-[60px]" />
    </>
  );
};
