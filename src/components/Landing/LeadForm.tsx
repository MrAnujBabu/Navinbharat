      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            >
              NEET ki tayyari, aaj se shuru.
            </h2>
            <p className="text-lg text-secondary-foreground/70 max-w-lg leading-relaxed">
              Ek free demo class book karein. Naveen Bharat faculty se milein aur dekhein kaise
              NCERT-based lessons, daily DPP aur weekly tests aapka score badalte hain.
            </p>
          </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.grade} onValueChange={(val) => handleInputChange("grade", val)}>
                  ...
                  <SelectContent>
                    {grades.map((g) => (
                      <SelectItem key={g} value={g}>{g === "Dropper" ? g : `Class ${g}`}</SelectItem>
                    ))}
                  </SelectContent>
                </Select>
              </div>
