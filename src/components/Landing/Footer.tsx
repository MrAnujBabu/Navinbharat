...
import { isNativeSync, openSocialLink } from "@/lib/native/openSocialLink";
  ...
  const cols = [
    {
      ...
      links: [
        ...
        { l: "NEET Dropper Batch", to: "/courses" },
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <p className="text-sm text-secondary-foreground/60 leading-relaxed max-w-xs">
              Roz ek chhota kadam, bada change. Naveen Bharat ke saath NEET ke liye NCERT-based
              video lessons, DPP, PYQ aur live doubt classes — sab kuch app ke andar.
            </p>
            ...
            <div className="flex items-center gap-3 pt-2">
              {[
                {
                  href: YOUTUBE_URL,
                  label: "Watch Naveen Bharat on YouTube",
                  icon: Youtube,
                },
                {
                  href: TELEGRAM_URL,
                  label: "Join Naveen Bharat on Telegram",
                  icon: Send,
                },
              ].map((s) => (
                <a
