...
/**
 * Dual-bubble hero: student girl (large, top-right) + Naveen Bharat faculty (medium,
    ...
    <div className="relative w-full aspect-[5/4] select-none">
      ...
      <div className="absolute top-0 right-0 w-[54%] aspect-square animate-fade-in-up [animation-delay:0.1s]">
        ...
        >
          <img
            src={studentGirlUrl}
            alt="Naveen Bharat student NEET ki taiyari karte hue"
      ...
      >
        Sir, NEET ki tayyari<br />kaise shuru karun?
      </button>

      {/* -------- Naveen Bharat faculty — medium, bottom-left -------- */}
      <div className="absolute bottom-0 left-[4%] w-[44%] aspect-square animate-fade-in-up [animation-delay:0.2s]">
        {/* outer dashed rotating accent ring around Naveen Bharat faculty — crisp SVG */}
        <svg
        ...
        >
          <img
            src={mentorUrl}
            alt="Naveen Bharat faculty — founding faculty, Naveen Bharat"
            className="h-full w-full object-cover object-top"
            loading="lazy"
            decoding="async"
          />
      ...
      {/* -------- Chat bubble — "Naveen Bharat ke saath..." (bottom-right, below girl) -------- */}
      <button
        type="button"
        onClick={scrollToCourses}
      ...
      >
        Naveen Bharat ke Saath<br />NCERT se concept clear, phir practice.
      </button>
    </div>
  </div>
));
