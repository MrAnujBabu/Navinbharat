...
export const Breadcrumbs = ({
  ...
  return (
    <nav
      className={cn(
        "flex items-center gap-1 text-xs overflow-x-auto whitespace-nowrap px-2 sm:px-3",
        "bg-gradient-to-r from-card/95 to-card/80 backdrop-blur-xl",
        "border-b border-border/40 shadow-[0_1px_3px_0_rgb(0_0_0/0.04)]",
        "scrollbar-none",
        className
      )}
      style={{
    ...
    >
      {showBack && (
        <button
          ...
          aria-label="Back"
          className={cn(
            "shrink-0 inline-flex items-center justify-center h-9 w-9 min-h-[44px] min-w-[44px] -ml-1 rounded-lg",
