    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          {/* PDF icon tile */}
          <div className={cn(
            "min-w-[56px] w-[56px] h-[56px] rounded-xl flex items-center justify-center flex-shrink-0",
            isCompleted ? "bg-green-50 dark:bg-green-950/30" : "bg-purple-50 dark:bg-purple-950/30"
          )}>
            {isLocked ? (
