    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          {/* Minimal monoline document tile — calm top-edtech feel
              (Linear/Notion/Apple Books). Avoids heavy filled glyphs. */}
          <div className={cn(
            "min-w-[56px] w-[56px] h-[56px] rounded-xl flex items-center justify-center flex-shrink-0 border",
            isCompleted
              ? "bg-green-50 border-green-200/60 dark:bg-green-950/30 dark:border-green-900/40"
              : "bg-muted/40 border-border/50 dark:bg-zinc-900"
          )}>
            {isLocked ? (
              ...
              <MinimalDocIcon size={26} className="text-foreground/70" />
            )}
          </div>
