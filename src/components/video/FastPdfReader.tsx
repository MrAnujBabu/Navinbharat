...
const FastPdfReader = forwardRef<FastPdfReaderHandle, Props>(
  ({ url, title, showLoadingOverlay = true, onSurfaceTap, onFirstByte, initialPage, onPageChange, onReady, readerId }, ref) => {
    ...
    }, [data, fallbackData, fetchPdfBlobWithRetry, friendlyPdfError, readerId, route, scheduleTransportRetry, src, url]);
    ...
    const onLoadError = useCallback(
      ...
      [fetchWholeFileFallback, friendlyPdfError, readerId, route, scheduleTransportRetry, src, url]
    );
