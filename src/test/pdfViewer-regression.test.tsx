...
describe("pdfViewerUrl helpers", () => {
  ...
  it("embeds Drive URLs via the native /preview iframe (zero edge-function load)", () => {
    const { embedUrl, isDrive } = resolveEmbedUrl(
      "https://drive.google.com/file/d/abc123/view"
    );
    expect(embedUrl).toBe("https://drive.google.com/file/d/abc123/preview");
...
describe("AutoScrollFab visibility", () => {
  ...
  it("HIDES the FAB for Google Drive PDFs (cross-origin /preview iframe, can't scroll)", () => {
    render(
