...
// Indirect dynamic import keeps `@capacitor/app` out of the web/SSR static
// graph — the bundler can't statically resolve `import(pkg)` so the plugin is
// loaded lazily only on native Android. See useAndroidBackButton.test.tsx.
