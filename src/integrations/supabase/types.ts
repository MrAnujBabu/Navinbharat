  ...
  public: {
    Tables: {
      ...
      live_reminders: {
        ...
        Relationships: [
          {
            foreignKeyName: "live_reminders_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "live_sessions"
            referencedColumns: ["id"]
    ...
    Functions: {
      admin_get_batch_roster: { Args: { _course_id: number }; Returns: Json }
      ...
      run_payment_settlement_sweep: { Args: never; Returns: undefined }
      search_lectures: {
      ...
      storage_url_matches_bucket_object: {
        Args: { _bucket: string; _object_name: string; _url: string }
        Returns: boolean
      }
      storage_url_matches_object: {
        Args: { _object_name: string; _url: string }
        Returns: boolean
      }
      ...
      verify_sweep_secret: { Args: { _secret: string }; Returns: boolean }
    }
    Enums: {
