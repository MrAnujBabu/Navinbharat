...
export const APP_LINK_HOSTS = [
  ...
  // Single app id: com.naveenbharat.app.
  "naveenbharat.vercel.app",
  // "sadguruclasses.vercel.app" removed: legacy brand host, retired — its links
  // now open in the browser. The old app id com.sadguru.classes is gone for good.
