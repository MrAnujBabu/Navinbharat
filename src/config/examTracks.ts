...
export const examTracks: ExamTrack[] = [
  {
    ...
    hero: {
      h1: "NEET Class 11 — Physics, Chemistry & Biology",
      subtitle:
        "Naveen Bharat ke saath NEET ki neev — Class 11 NCERT ka har chapter, concept videos, DPP aur chapter-wise test. Simple bhasha mein samjhaya gaya.",
      metaTitle: "NEET Class 11 Course (PCB) | Naveen Bharat",
      metaDescription:
    ...
    includes: [
      "400+ recorded lessons, easy explanation",
    ...
    faqs: [
      { q: "Ye batch kiske liye hai?", a: "Class 11 ke students jo NEET target kar rahe hain — simple bhasha mein specially designed." },
  ...
  },
  {
    ...
    hero: {
      ...
      metaDescription:
        "NEET Class 12 ki taiyari aasan bhasha mein — NCERT-based lessons, previous year questions, weekly mock tests aur doubt support. Board aur NEET dono cover.",
    },
    syllabus: [
    ...
    faqs: [
      ...
      { q: "Language kya hai?", a: "Explanation aasan bhasha mein, technical terms English mein — bilingual approach." },
  ...
  },
  {
    ...
    hero: {
      ...
      metaTitle: "NEET Dropper Batch (Repeater) | Naveen Bharat",
      metaDescription:
        "NEET dropper batch — Class 11 aur 12 ka full revision, PYQ marathon, weekly full-length mock test aur daily doubt support. Simple bhasha mein.",
    },
    syllabus: [
