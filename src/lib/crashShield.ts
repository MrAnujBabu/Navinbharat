...
const EXPECTED_REJECTION_RE =
  /network|fetch|offline|failed to fetch|aborted|abort|timeout|timed out|401|403|cancell?ed|websocket (connection failed|closed without opened|is closed|disconnect)|HMR/i;
