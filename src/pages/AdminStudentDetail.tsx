...
type Snapshot = {
  ...
  last_session: { created_at?: string | null; platform?: string | null } | null;
};
...
const AdminStudentDetail = () => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchAll is a mount-scoped loader keyed on the route param; adding it would loop.
              ...
              <Card>
                ...
                <CardContent className="p-0">
                  <div className="divide-y divide-border">
                    ...
                    {data.enrollments.map((e: SnapshotEnrollment) => (
              ...
              <Card>
                ...
                <CardContent className="p-0">
                  <div className="divide-y divide-border">
                    ...
                    {data.payments.slice(0, 20).map((pay: SnapshotPayment) => (
...
const Stat = ({ icon: Icon, label, value }: { icon: LucideIcon; label: string; value: React.ReactNode }) => (
