...
const MyCourseDetail = () => {
  ...
  useEffect(() => {
    ...
    setCompletedLessonIds(d.completedSet);
  ...
  const handleToggleComplete = useCallback(async (lesson: Lesson) => {
                        ...
                        <div className={viewMode === "list" ? "space-y-1.5" : "space-y-4"}>
                          {filteredLessons.map((lesson) => (
                            <LectureCard
                              ...
                              onNotesClick={() => setNotesSheetLesson(lesson)}
                              ...
                              onMarkComplete={(e) => { e.stopPropagation(); handleToggleComplete(lesson); }}
                            />
