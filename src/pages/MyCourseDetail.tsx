...
const MyCourseDetail = () => {
  ...
  const [viewMode, setViewMode] = useState<ViewMode>(() => {
    try {
      ...
      // This page only offers Gallery + List (see ContentViewSwitcher
      // `modes` below), so a persisted "table" from another page must
      // fall back to list instead of rendering an unreachable mode.
            ...
            <div className="hidden md:flex items-center gap-2 px-4 py-2">
              ...
              {selectedChapterId && !selectedLesson && (
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  <ContentViewSwitcher activeView={viewMode} onViewChange={handleViewModeChange} modes={["gallery", "list"]} />
                </div>
              )}
              <button
