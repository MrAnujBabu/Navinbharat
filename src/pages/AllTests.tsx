...
import type { LessonRow, QuizRow } from "@/types/rows";
  ...
  useEffect(() => {
    const fetchTests = async () => {
      ...
      try {
        ...
        const lessonIds = (data || []).map((l: LessonRow) => l.id);
        ...
        const allTests: TestLesson[] = (data || []).map((l: LessonRow) => ({
          id: l.id,
          title: l.title,
        ...
        const standaloneTests: TestLesson[] = (standaloneQuizzes || []).map((q: QuizRow) => {
