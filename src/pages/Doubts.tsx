...
const Doubts = () => {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- fetchSessions is a mount-scoped loader; adding it would refetch on every render.
  }, [user]);
  ...
  const handleSubmitRequest = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) throw error;
      toast.success("Doubt submitted! Naveen Bharat AI Sahayak jawab taiyar kar raha hai...");
      setForm({ subject: "", description: "", course_id: "", scheduled_at: "" });
      fetchSessions();

      // Call Naveen Bharat AI Sahayak to auto-resolve
      if (newSession?.id) {
        try {
          ...
          toast.success("Naveen Bharat AI Sahayak ne aapke doubt ka jawab diya hai!");
        } catch (aiErr) {
          ...
          {selectedSession && (
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <Input aria-label="Session start time"
                  type="datetime-local"
        ...
        <div className="flex items-center gap-1.5 mb-1">
          {node.is_ai ? (
            <>
              ...
              <span className="text-xs font-semibold text-primary">Naveen Bharat AI Sahayak</span>
            </>
          ) : (
