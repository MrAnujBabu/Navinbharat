...
const ExamLanding = memo(() => {
  ...
  const courseJsonLd = {
    ...
    provider: {
      "@type": "Organization",
      name: "Naveen Bharat",
      sameAs: "https://youtube.com/@naveenbharat",
    },
    inLanguage: ["hi", "en"],
          ...
          <div className="container mx-auto max-w-4xl px-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                10+ saal ka teaching experience, students ko English fluently sikhane
                mein specialization. YouTube channel <em>Naveen Bharat Ka</em> pe 5 lakh+ learners.
              </p>
            </div>
          </div>
        </section>
