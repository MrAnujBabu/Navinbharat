    ...
    if (Capacitor.isNativePlatform()) {
      try {
        ...
        if (e instanceof RazorpayCancelledError) {
          ...
          void notifyError();
          // Native plugin surfaces Razorpay's raw error message; run it
          // through the same formatter as web so users see actionable copy
          // instead of "undefined" / "payment_authentication".
