...
const DauLineChart = lazy(() => import("../components/admin/analytics/DauLineChart"));
const CourseCompletionChart = lazy(() => import("../components/admin/analytics/CourseCompletionChart"));
const QuizPassFailChart = lazy(() => import("../components/admin/analytics/QuizPassFailChart"));
