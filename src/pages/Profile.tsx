...
import { ArrowLeft, User, Mail, Shield, LogOut, Phone, RefreshCw } from "lucide-react";
...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {/* Audit fix: Header is `fixed top-0` with min-h 52 px (mobile) / 60 px
          (desktop) + safe-area-top. Without this spacer the blue Profile
          banner slides under the fixed header and the hamburger icon
          overlaps the "Profile" title. The spacer reserves the same
          height + safe-area inset the Header consumes. */}
      <div
        aria-hidden="true"
        className="shrink-0"
