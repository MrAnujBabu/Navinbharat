...
const Login = () => {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      const errorMsg = mapError(getErrorMessage(err, "") || "Sign-in failed. Please try again.");
    ...
    <main className="min-h-dvh bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 bg-primary items-center justify-center p-12">
        <div className="max-w-lg text-center text-primary-foreground">
          ...
          <p className="text-primary-foreground/80 text-lg">Naveen Bharat pe wapas swagat hai.</p>
        </div>
      </div>
    </main>
  );
