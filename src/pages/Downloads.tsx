...
// WindowAutoScrollFab removed — see note near end of file.
...
const Downloads = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* WindowAutoScrollFab removed: it was rendering on the Downloads list
          itself, which has no long-form content to auto-scroll. The PDF
          reader (UniversalFileViewer → DocReaderShell) brings its own
          AutoScrollFab when a document is opened, so this window-level FAB
