...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-muted/30 flex flex-col font-sans">
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 max-w-7xl mx-auto w-full pb-20 md:pb-6 pt-[calc(52px+env(safe-area-inset-top)+0.75rem)] md:pt-[calc(60px+env(safe-area-inset-top)+1rem)]">
