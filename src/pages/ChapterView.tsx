...
import type { ChapterRow, ProgressRow } from "@/types/rows";
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const completedLessonIds = new Set((progressRes.data || []).map((p: ProgressRow) => p.lesson_id));
        ...
        const mappedChapters: Chapter[] = (chaptersRes.data || []).map((ch: ChapterRow) => {
