...
const Signup = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // eslint-disable-next-line react-hooks/exhaustive-deps -- submitTimerRef holds a timer id, not a DOM node — reading `.current` at cleanup is the correct teardown.
