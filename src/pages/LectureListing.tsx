...
const LectureListing = () => {
  ...
  useEffect(() => {
    ...
    chapterCache.set(cacheKey, {
      chapter, parentChapter, subChapters, lessons, showSubChapters,
    });
  }, [loading, cacheKey, chapter, parentChapter, subChapters, lessons, showSubChapters]);
                        ...
                        <div className="flex items-start gap-1">
                          <div className="flex-1 min-w-0">
                            <LectureCard
                              ...
                              onNotesClick={() => handleLectureClick(lesson, { openPdf: true })}
                            />
                          </div>
