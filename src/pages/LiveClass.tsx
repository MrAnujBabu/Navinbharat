...
const LiveClass = () => {
  ...
  // Shared safety kit: ref-counted FLAG_SECURE + web screenshot shield +
  // mount guard for post-await setters (see safe-surface-handling).
  ...
  }, [sessionId, isAuthenticated, authLoading, navigate, isMountedRef]);
  ...
  if (loading || authLoading) {
    // Skeleton matching the final layout instead of a spinner on a blank page.
    return (
  ...
  return (
    <div className="min-h-dvh bg-background flex flex-col">
      ...
      <SafeBoundary fallbackTitle="Live class failed to load">
