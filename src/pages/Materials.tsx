      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-2">
          <div className="relative flex-1">
            ...
            <Input aria-label="Search materials" placeholder="Search materials..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-9" />
          </div>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>Title</Label>
                <Input aria-label="Material title" placeholder="Material title" value={title} onChange={(e) => setTitle(e.target.value)} />
              </div>
              <div className="space-y-2">
