...
public class MainActivity extends BridgeActivity {
    ...
    /** True while a surface (fullscreen video / PDF reader) owns immersive mode. */
    private boolean immersiveActive = false;

    /**
     * Android restores the system bars whenever the Activity regains focus
     * (app switcher, permission dialog, notification shade). Without this the
     * status bar (clock / battery) stayed visible over a fullscreen PDF.
     */
    @Override
    public void onWindowFocusChanged(boolean hasFocus) {
        super.onWindowFocusChanged(hasFocus);
        if (hasFocus && immersiveActive) enterImmersive();
    }
    ...
    static boolean isTrustedOriginUrl(String url) {
        ...
        return url.startsWith("https://localhost")
            ...
            || url.startsWith("https://naveenbharat.in")
            || url.startsWith("https://www.naveenbharat.in")
            || url.startsWith("https://app.naveenbharat.in")
            || url.startsWith("https://navinbharat.vercel.app");
            // sadguruclasses.vercel.app removed: retired legacy brand host.
    }
