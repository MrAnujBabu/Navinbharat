...
public class MainActivity extends BridgeActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (this.bridge != null && this.bridge.getWebView() != null) {
            this.bridge.getWebView().setWebChromeClient(new BridgeFullscreenWebChromeClient(this));
...
class ImmersiveBridge {
    ...
    private boolean isTrustedOrigin() {
        try {
            String url = activity.bridge != null && activity.bridge.getWebView() != null
                ? activity.bridge.getWebView().getUrl() : null;
